...
SECRET_KEY = os.getenv("FRONTEND_API_SECRET_KEY")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("FRONTEND_DATABASE_NAME"),
        'USER': os.getenv("FRONTEND_DATABASE_USER"),
        'PASSWORD': os.getenv("FRONTEND_DATABASE_PASSWORD"),
        'HOST': os.getenv("FRONTEND_DATABASE_HOST"),
        'PORT': os.getenv("FRONTEND_DATABASE_PORT"),
    }
}
